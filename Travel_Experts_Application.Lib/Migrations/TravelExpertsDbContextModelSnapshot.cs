...
{
    [DbContext(typeof(TravelExpertsDbContext))]
    partial class TravelExpertsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Affiliation", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Agency", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Agent", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Booking", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.BookingDetail", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Class", b =>
                {
                    b.Property<string>("ClassId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.CreditCard", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Customer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.CustomersReward", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Fee", b =>
                {
                    b.Property<string>("FeeId")
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Package", b =>
                {
                    b.Property<int>("PackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.PackagesProductsSupplier", b =>
                {
                    ...
                    b.HasKey("PackageProductSupplierId")
                        .HasName("PK__Packages__53E8ED9965F6EAB5");
                    ...
                    b.HasIndex(new[] { "PackageId", "ProductSupplierId" }, "UQ__Packages__29CA8E95AB5A33A5")
                        .IsUnique();

                    b.ToTable("Packages_Products_Suppliers");
                });

            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.ProductsSupplier", b =>
                {
                    b.Property<int>("ProductSupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Region", b =>
                {
                    b.Property<string>("RegionId")
                        .HasMaxLength(5)
                        .HasColumnType("nvarchar(5)");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Reward", b =>
                {
                    b.Property<int>("RewardId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.SupplierContact", b =>
                {
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.TripType", b =>
                {
                    b.Property<string>("TripTypeId")
                        .HasMaxLength(1)
                        .HasColumnType("nvarchar(1)");
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Agent", b =>
                {
                    b.HasOne("Travel_Experts_Application.Lib.Models.Agency", "Agency")
                        .WithMany("Agents")
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Booking", b =>
                {
                    b.HasOne("Travel_Experts_Application.Lib.Models.Customer", "Customer")
                        .WithMany("Bookings")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("Bookings_FK00");

                    b.HasOne("Travel_Experts_Application.Lib.Models.Package", "Package")
                        .WithMany("Bookings")
                        .HasForeignKey("PackageId")
                        .HasConstraintName("Bookings_FK01");

                    b.HasOne("Travel_Experts_Application.Lib.Models.TripType", "TripType")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.BookingDetail", b =>
                {
                    b.HasOne("Travel_Experts_Application.Lib.Models.Booking", "Booking")
                        .WithMany("BookingDetails")
                        .HasForeignKey("BookingId")
                        .HasConstraintName("FK_BookingDetails_Bookings");

                    b.HasOne("Travel_Experts_Application.Lib.Models.Class", "Class")
                        .WithMany("BookingDetails")
                        .HasForeignKey("ClassId")
                        .HasConstraintName("FK_BookingDetails_Classes");

                    b.HasOne("Travel_Experts_Application.Lib.Models.Fee", "Fee")
                        .WithMany("BookingDetails")
                        .HasForeignKey("FeeId")
                        .HasConstraintName("FK_BookingDetails_Fees");

                    b.HasOne("Travel_Experts_Application.Lib.Models.ProductsSupplier", "ProductSupplier")
                        .WithMany("BookingDetails")
                        .HasForeignKey("ProductSupplierId")
                        .HasConstraintName("FK_BookingDetails_Products_Suppliers");

                    b.HasOne("Travel_Experts_Application.Lib.Models.Region", "Region")
                        .WithMany("BookingDetails")
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.Customer", b =>
                {
                    b.HasOne("Travel_Experts_Application.Lib.Models.Agent", "Agent")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.CustomersReward", b =>
                {
                    ...
                    b.HasOne("Travel_Experts_Application.Lib.Models.Reward", "Reward")
                        .WithMany("CustomersRewards")
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.ProductsSupplier", b =>
                {
                    b.HasOne("Travel_Experts_Application.Lib.Models.Product", "Product")
                        .WithMany("ProductsSuppliers")
                        .HasForeignKey("ProductId")
                        .HasConstraintName("Products_Suppliers_FK00");

                    b.HasOne("Travel_Experts_Application.Lib.Models.Supplier", "Supplier")
                        .WithMany("ProductsSuppliers")
            ...
            modelBuilder.Entity("Travel_Experts_Application.Lib.Models.SupplierContact", b =>
                {
                    b.HasOne("Travel_Experts_Application.Lib.Models.Affiliation", "Affiliation")
